...
Статус: **предложено, ожидает GitHub issue и явного разрешения на зависимости**.
...
## Условия начала внедрения

До добавления `package.json`, TypeScript и npm-зависимостей требуется:

1. Создать GitHub issue из `docs/FRONTEND_DEPENDENCY_ISSUE.md`.
2. Получить явное разрешение владельца на перечисленные зависимости и новый язык TypeScript.
3. Зафиксировать в issue принятое решение или ссылку на разрешение.
